...
function renderizarCardapio() {
  ...
  produtosFiltrados.forEach((produto) => {
    ...
    const imgHTML = produto.imagemBase64
      ? `<img src="${produto.imagemBase64}" class="produto-img" alt="${produto.nome}">`
      : `<div class="produto-img-placeholder">🍽️</div>`;

    div.innerHTML = `
      ${imgHTML}
      <div class="produto-content">
        <h3>${produto.nome}</h3>
        <p class="produto-desc">${produto.descricao || "Ingredientes selecionados especialmente para você."}</p>
